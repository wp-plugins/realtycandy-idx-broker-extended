 ...
 * @see RC_Idx_Api
 */
class RC_City_Links_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
	 		'rc_city_links', // Base ID
			'RealtyCandy :: IDX City Links', // Name
			array(
				'description' => __( 'Outputs a list of city links', 'realtycandy' ),
				'classname'   => 'rc-city-links-widget'
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		// 		$instance['mls'] = 'a000';
		// }
		echo '<style>.city-list-links .columns.small-12 {float:left;width: 25%;}</style>';
		if ( empty($instance['mls'] ) ) {
			echo 'Invalid MLS IDX ID. Email help@idxbroker.com to get your MLS IDX ID. Current API Key: ';
      echo $_idx->api_key;
		} else {
